...
// Anchors at the top-center of each element (not the center) — the two ends meet the top edge of each card.
    ...
    useEffect(() => {
        function updatePath() {
            ...
            if (container && from && to) {
                ...
                const startY = rectA.top - containerRect.top
            ...
            frameRef.current = requestAnimationFrame(updatePath)
        }
