...
export function ContextPanel({
  ...
  return (
    <div className="px-6 py-4 flex flex-col gap-4 min-h-0 min-w-0 overflow-y-auto overflow-x-hidden scroll-smooth">
      <div className={`${kicker} text-1_2 mb-2`}>{project.name}</div>
      <div className="text-xs leading-snug break-words">{project.description}</div>
