    ...
    return (
      <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
        <SheetContent
          ...
          data-slot="sidebar"
          data-mobile="true"
          className="v2 font-sans w-[var(--sidebar-width)]! max-w-[var(--sidebar-width)]! bg-sidebar p-0 text-sidebar-foreground [&>button]:hidden"
          style={
            {
...
function SidebarTrigger({
  ...
  return (
    ...
    >
      {
        isMobile ?  <MenuIcon className="size-icon-xs" strokeWidth={1.75} /> :  <PanelLeft className="size-icon-xs" strokeWidth={1.75} />
      }
