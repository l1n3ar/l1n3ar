    ...
    <div>
      ...
      <CaseBody>
        ...
        <CaseSection heading="what I actually built">
          ...
          <CaseImage
            src="/case-media/eiger/blind-signature-flow.svg"
            alt="Blind-signature flow: the holder (wallet) blinds a coin and sends it to the issuer (central bank), who signs it blind and returns it, the holder unblinds and stores it, and later a verifier (merchant) checks the coin at payment, all built on a specialist team's post-quantum crypto library."
          />
